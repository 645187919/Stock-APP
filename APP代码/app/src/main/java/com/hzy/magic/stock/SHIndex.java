 ...
 */
public class SHIndex extends Activity implements View.OnClickListener {
    public static SHIndexBean sDBean;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sDBean= (SHIndexBean) intent.getSerializableExtra("shindexBean");
