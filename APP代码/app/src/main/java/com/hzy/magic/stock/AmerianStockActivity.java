...
public class AmerianStockActivity extends Activity implements AdapterView.OnItemClickListener {
...
//        }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                //请求网络数据
                ArrayList<StockBean> allNews = HttpForUSA.getAllstockListForNetWork(getContext(), StockAPI.getUSAAll(1));
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        String url = StockAPI.getUSA(bean.getSymbol());
