...
/**
 * Created by magic on 2017/4/2.
 */


public class szStockActivity extends Activity implements AdapterView.OnItemClickListener {
...
//        }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                //请求网络数据
                ArrayList<StockBean> allNews = HttpRequestForList.getAllstockListForNetWork(getContext(), StockAPI.getSZAll(1));
